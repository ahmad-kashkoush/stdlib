...
tape( 'attached to the prototype of the returned function is an `sort` method', function test( t ) {
	var ctor = factory( 'float64' );
	t.strictEqual( hasOwnProp( ctor.prototype, 'sort' ), true, 'returns expected value' );
	t.strictEqual( isFunction( ctor.prototype.sort ), true, 'returns expected value' );
	t.end();
});
